                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                ...
                                <button class="btn bg-purple bg-font-purple btn-xs deliver-product deliver-product-{{$target->id}}  tooltips" data-id="{{$target->id}}" type="submit" data-placement="top" data-rel="tooltip" data-original-title="@lang('label.CLICK_HERE_TO_DELIVER')">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.deliver-product', function (e) {
        ...
        swal({
            ...
            if (isConfirm) {
                $('.deliver-product-' + id).prop('disabled', true);
                form.submit();
            }
