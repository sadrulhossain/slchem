                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        <div class="form-group">
                            <label class="control-label col-md-4" for="parentCategory">@lang('label.PARENT_CATEGORY') :</label>
                            <div class="col-md-8">
                                {!! Form::select('parent_id', array('0' => __('label.SELECT_CATEGORY_OPT')) + $parentArr, null, ['class' => 'form-control js-source-states', 'id' => 'productCatId']) !!}
