...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-industry"></i>@lang('label.GARMENTS_TYPE_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[29][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('garmentsType/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_GARMENTS_TYPE')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'garmentsType/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    @if(!empty($userAccessArr[29][3]))
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('garmentsType/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[29][4]))
                                    {{ Form::open(array('url' => 'garmentsType/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_GARMENTS_TYPE_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
