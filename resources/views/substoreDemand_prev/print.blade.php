        ...
        <table class="no-border">
            <thead>
                <tr class="info">
                    ...
                    @if($demandInfo['delivered'] == '1')
                    <th class="vcenter text-center bold" colspan="6">@lang('label.TRACK_LOT')</th>
                    @endif
                </tr>
            ...
            <tbody>
                ...
                <?php
                $rowspan = (isset($productWithLotArr[$item->product_id]) && !empty($productWithLotArr[$item->product_id])) ? sizeof($productWithLotArr[$item->product_id]) : '1';
                ?> 
                <tr>
