...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-industry"></i>@lang('label.FACTORY_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[28][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('factory/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_FACTORY')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'factory/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    @if(!empty($userAccessArr[28][3]))
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('factory/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[28][4]))
                                    {{ Form::open(array('url' => 'factory/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_FACTORY_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
