<html>
    ...
    <body>
        ...
        <table class="no-border recipe-table">
            <thead>
                <tr class="info header-color">
                    <th class="text-center" colspan="12">@lang('label.BULK_WASH_RECIPE')</th>
                </tr>
                <tr>
                    ...
                    <th class="vcenter text-center">@lang('label.TOTAL_QTY')</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="vcenter" colspan="5">{{ $process['dry_chemical'] }}</td>
                    <td class="vcenter text-center">{{ $process['ph'] }}</td>
                    <td class="vcenter text-center">{{ Helper::numberformat($process['temperature']) }}</td>
                ...
                <tr>
                    ...
                    <td class="vcenter text-center">{{ Helper::numberformat($process['water']) }}</td>
                ...
                <tr>
                    ...
                    @else
                    <td class="vcenter text-right">{{ Helper::numberformat($product['qty']) }}</td>
                    @endif
                    <td class="vcenter text-right">{{ Helper::numberformat($product['total_qty']) }}</td>
                    @if($i == 0)
                    <td class="vcenter text-center" rowspan="{{count($productArr[$process['process_id']])}}">{{ Helper::numberformat($process['water']) }}</td>
                    <td class="vcenter text-center" rowspan="{{count($productArr[$process['process_id']])}}">{{ Helper::numberformat($process['ph']) }}</td>
                    <td class="vcenter text-center" rowspan="{{count($productArr[$process['process_id']])}}">{{ Helper::numberformat($process['temperature']) }}</td>
                ...
                <tr>
                    <td colspan="5">&nbsp;</td>
                    <td><strong>@lang('label.TOTAL_WATER')</strong></td>
                    <td class="text-center"><strong>{!! Helper::numberformat($totalWater) !!}</strong></td>
                    <td colspan="5">&nbsp;</td>
                </tr>
                @endif
            </tbody>
