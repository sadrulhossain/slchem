<div class="modal-header clone-modal-header">
    ...
    <div class="col-md-6">
        ...
        <a href="{{ URL::to('batchCard/getRecipeDetails/'.$target->id.'?view=print') }}" target="_blank" class="btn btn-md btn-success pull-right margin-right-10">
        ...
        <div class="col-md-12">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td class="vcenter bold">{!! $target->wash_type !!}</td>		
                    @endif
                </tr>
                <tr>
