...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-line-chart"></i>@lang('label.DAILY_CONSUMPTION')
            </div>
        </div>
        <div class="portlet-body">
            ...
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'dailyConsumptionReport/filter','class' => 'form-horizontal')) !!}
            ...
            <div class="row">
                <div class="col-md-offset-8 col-md-4" id="manageEvDiv">
                    ...
                    <a class="btn btn-md btn-success vcenter tooltips" target="_blank" title="Click here to Print Daily Consumption Report"  href="{!! URL::full().'&view=print' !!}">
