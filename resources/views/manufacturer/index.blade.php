...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-users"></i>@lang('label.MANUFACTURER_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[10][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('manufacturer/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_MANUFACTURER')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'manufacturer/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('manufacturer/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[10][4]))
                                    {{ Form::open(array('url' => 'manufacturer/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
