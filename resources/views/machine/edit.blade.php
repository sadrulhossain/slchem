...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cart-plus"></i>@lang('label.EDIT_WASHING_MACHINE')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('machine.update', $target->id), 'method' => 'PATCH','class' => 'form-horizontal'] ) !!}
                ...
                <div class="row">
                    <div class="col-md-offset-1 col-md-7">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="machineModelId">@lang('label.SELECT_WASHING_MACHINE_TYPE') :<span class="text-danger"> *</span></label>
                            <div class="col-md-8">
