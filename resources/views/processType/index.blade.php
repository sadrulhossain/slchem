...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cog"></i>@lang('label.PROCESS_TYPE_LIST')
            </div>
            <div class="actions">
                @if(!empty($userAccessArr[24][2]))
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('processType/create'.Helper::queryPageStr($qpArr)) }}"> @lang('label.CREATE_NEW_PROCESS_TYPE')
        ...
        <div class="portlet-body">
            <div class="row">
                <!-- Begin Filter-->
                {!! Form::open(array('group' => 'form', 'url' => 'processType/filter','class' => 'form-horizontal')) !!}
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter text-center">
                                <div>
                                    @if(!empty($userAccessArr[24][3]))
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('processType/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[24][4]))
                                    {{ Form::open(array('url' => 'processType/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
                        ...
                        @else
                        <tr>
                            <td colspan="5" class="vcenter">@lang('label.NO_PROCESS_TYPE_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
