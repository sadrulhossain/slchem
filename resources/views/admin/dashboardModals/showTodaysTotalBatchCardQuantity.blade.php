<div class="modal-header clone-modal-header">
    <div class="col-md-6">
        <h4 class="modal-title"><strong>@lang('label.TODAYS_TOTAL_BATCH_CARD_QUANTITY')</strong></h4>
    </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row elements">
                    <div class="col-md-6">
                        <button class="btn mt-ladda-btn ladda-button btn-circle bg-blue-dark bg-font-blue-dark">
                ...
                <div class="table-responsive max-height-500 webkit-scrollbar">
                    <table class="table table-bordered table-hover table-head-fixer-color">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="vcenter vcenter text-center">{{ ++$serial }}</td>
                                ...
                                <td class=" vcenter text-center bold">{{ $target->wash_lot_quantity_piece }}</td>
