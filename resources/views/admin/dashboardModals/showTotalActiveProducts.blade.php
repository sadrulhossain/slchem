<div class="modal-header clone-modal-header">
    <div class="col-md-6">
        <h4 class="modal-title"><strong>@lang('label.TOTAL_ACTIVE_PRODUCTS')</strong></h4>
    </div>
            ...
            <div class="col-md-12">
                <ul class="padding-left-0">
                    <li class="list-style-item-none display-inline-block margin-top-10">
                        <span class="label label-md bold label-blue-steel">@lang('label.TOTAL_ACTIVE_PRODUCTS') : {!! !empty($totalActiveProductsCount) ? $totalActiveProductsCount : 0 !!}</span>
                    </li>
