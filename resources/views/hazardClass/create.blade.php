...
<div class="col-md-12">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-industry"></i>@lang('label.CREATE_HAZARD_CLASS')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'hazardClass','files'=> 'true','class' => 'form-horizontal','id'=> 'submit_form')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="md-checkbox-inline md-checkbox has-success">
                                        {!! Form::checkbox('pictogram_id[]',$pictogram->id,false, ['id' => 'pictogramId_'.$pictogram->id, 'class'=>'md-check']) !!} 
