    ...
    <body>
        ...
        <table class="no-border recipe-table">
            ...
            <tbody>
                ...
                @foreach($washTypeToWaterArr as $washTypeId => $waterVal)	
                <tr>
                    <td colspan="7" class="text-right"><strong>@lang('label.TOTAL_WATER') @lang('label.OF') {!! $washTypeArr[$washTypeId] !!}</strong></td>
