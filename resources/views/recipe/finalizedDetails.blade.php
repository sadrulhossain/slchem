<div class="modal-header clone-modal-header">
    ...
    <div class="col-md-6">
        ...
        @if(!empty($userAccessArr[45][6]))
        <a href="{{ URL::to('finalizedRecipe/getDetails/'.$target->id.'?view=print') }}" target="_blank" class="btn btn-md btn-success pull-right margin-right-10">
            <i class="fa fa-print text-white"></i> @lang('label.PRINT')
        </a>
        @endif
        @if(!empty($userAccessArr[45][17]))
        <a class="btn btn-md btn-warning pull-right tooltips margin-right-10" title="Click here to Download PDF" href="{{ URL::to('finalizedRecipe/getDetails/'.$target->id.'?view=pdf') }}">
