<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#processId').on('change', function () {
            ...
            if (processId != '0') {
                $.ajax({
                    url: "{{URL::to('recipe/getProductsEdited')}}",
                    type: "POST",
                    data: {
        ...
        $('#factoryId').on('change', function () {
            ...
            if (factoryId != '0') {
                $.ajax({
                    url: "{{URL::to('recipe/getFactoryCodeEdited')}}",
                    type: "POST",
                    data: {
        ...
        $('#dryerTypeId').on('change', function () {
            ...
            if (dryerType != '0') {
                $.ajax({
                    url: "{{URL::to('recipe/getDryerMachineEdited')}}",
                    type: "POST",
                    data: {
        ...
        $('#addItem').click(function () {
            ...
            $.ajax({
                url: "{{ URL::to('recipe/addProcessEdited')}}",
                type: "POST",
                dataType: 'json',
                cache: false,
                headers: {
                ...
                if (isConfirm)
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            location.href = '{!! URL::to("recipe") !!}' + page;
...
//                var selectedProductId = identifierProcessId + "-"+ $(this).val();
            ...
            $.ajax({
                url: "{{ URL::to('recipe/updateProcessEdited')}}",
                type: "POST",
                dataType: 'json',
                cache: false,
                headers: {
