<html>
    <head>
        ...
        <link href="{{asset('public/assets/layouts/layout/css/downloadPdfPrint/print.css')}}" rel="stylesheet" type="text/css" media="all" />
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="bold">@lang('label.MONTHLY_PRODUCT_STATUS_REPORT') ({!!  date("F Y",strtotime($request->month)) !!})</h2>
            </div>
        </div>
        <!--        <div class="report-title">
                    <p>@lang('label.MONTH'): </p>
                </div>-->
        <table class="table table-bordered table-hover">
            <thead>
                ...
                <tr class="info">
                    ...
                    <th class="text-center vcenter">@lang('label.BEFORE')&nbsp;@lang('label.DETAILS')</th>
                    ...
                    <th class="text-center vcenter">@lang('label.TODAY')&nbsp;@lang('label.DETAILS')</th>
