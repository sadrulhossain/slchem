...
<div class="col-md-12">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cart-plus"></i>@lang('label.BUYER_LIST')
            </div>
            <div class="actions">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="vcenter">
                                ...
                                <img width="80" height="80" src="{{URL::to('/')}}/public/uploads/buyer/{{$target->logo}}" alt="{{ $target->name}}"/>
                                @else
                            ...
                            <td>
                                <div class="text-center">
                                    ...
                                    <a class="btn btn-xs btn-primary tooltips" title="Edit" href="{{ URL::to('buyer/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    @endif
                                    @if(!empty($userAccessArr[27][4]))
                                    {{ Form::open(array('url' => 'buyer/' . $target->id.'/'.Helper::queryPageStr($qpArr))) }}
                        ...
                        @else
                        <tr>
                            <td colspan="8">@lang('label.NO_BUYER_FOUND')</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
